...
export class DefaultBuilderFactory<C extends Config = Config,
  CB extends ConfigBuilder = ConfigBuilder,
  SB extends ServiceBuilder = ServiceBuilder,
  SWB extends ServiceWithBuilder = ServiceWithBuilder,
  SVB extends ServiceVolumeBuilder = ServiceVolumeBuilder> implements BuilderFactory<C, CB, SB, SWB, SVB> {
